...
@section('title')
    About Us 02 - Glowing - Bootstrap 5 HTML Templates
@endsection
                    ...
                    <div class="">
                        <div class="d-flex justify-content-center">
                            <img
                                ...
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-11.png') }}"
                                width="102"
                                height="118"
                                alt="Guaranteed PURE"
                            />
                            <img
                                ...
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-white-11.png') }}"
                                width="102"
                                height="118"
                                alt="Guaranteed PURE"
                            />
                        ...
                        <div class="card-body text-center pt-7 mt-3">
                            ...
                            <p class="mb-0 px-lg-6">
                                ...
                                purity standards and will never contain
                    ...
                    <div class="">
                        <div class="d-flex justify-content-center">
                            <img
                                class="lazy-image img-fluid light-mode-img"
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-02.png') }}"
                                width="102"
                                height="118"
                            ...
                            <img
                                class="lazy-image dark-mode-img img-fluid"
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-white-02.png') }}"
                                width="102"
                                height="118"
                                alt="Completely Cruelty-Free"
                            />
                    ...
                    <div class="">
                        <div class="d-flex justify-content-center">
                            <img
                                class="lazy-image img-fluid light-mode-img"
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-03.png') }}"
                                width="102"
                                height="118"
                            ...
                            <img
                                class="lazy-image dark-mode-img img-fluid"
                                src="#"
                                data-src="{{ asset('assets/front/images/image-box/image-box-white-03.png') }}"
                                width="102"
                                height="118"
                                alt="Ingredient Sourcing"
                            />
