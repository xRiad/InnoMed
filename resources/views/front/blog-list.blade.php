...
<html lang="en" data-bs-theme="light">
	<head>
		...
		<title>Blog List - Glowing - Bootstrap 5 HTML Templates</title>
		<link rel="icon" href="{{ asset('/images/others/favicon.ico') }}" />

		<link
			rel="stylesheet"
			href="{{ asset('/vendors/lightgallery/css/lightgallery-bundle.min.css') }}"
		/>
		<link
			rel="stylesheet"
		...
		<link
			rel="stylesheet"
			href="{{ asset('/vendors/animate/animate.min.css') }}"
		/>
		<link rel="stylesheet" href="{{ asset('/vendors/slick/slick.css') }}" />
		<link
			rel="stylesheet"
			href="{{ asset('/vendors/mapbox-gl/mapbox-gl.min.css') }}"
		/>
		<link
			rel="stylesheet"
	...
	<body>
					...
					<div class="pt-8 d-flex">
						...
						>
							<img
								...
								src="{{ asset('/images/others/logo.png') }}"
								width="179"
								height="26"
								alt="Glowing - Bootstrap 5 HTML Templates" />
							<img
								class="dark-mode-img"
								src="{{ asset('/images/others/logo-white.png') }}"
								width="179"
								height="26"
								alt="Glowing - Bootstrap 5 HTML Templates"
						/></a>
				...
				<div class="row">
					<div class="col-lg-8 order-lg-1">
						<div class="row gy-11">
							<div class="col-12">
								<article
									class="card card-post-list bg-transparent border-0"
								...
								>
									<div class="row align-items-center">
										...
										>
											<figure
												class="card-img-top mb-7 mb-md-0 mb-lg-7 mb-xl-0"
											>
												<a
													href="#"
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-01-370x240.jpg') }}"
										...
										>
											<div class="card-body p-0">
												...
												>
													<li
														class="list-inline-item border-end pe-5 me-5"
													>
														<a
												...
												<h4
													class="card-title fs-5 lh-base mt-5 pt-2 mb-0"
												>
													<a
														class="text-decoration-none"
														href="../blog/details-01.html"
														title="How to Plop Hair for Bouncy, Beautiful Curls"
														>How to Plop Hair for
														Bouncy, Beautiful
														Curls</a
													>
												</h4>
												<p class="card-text mt-4 mb-9">
												...
												<a
													class="btn-link border-bottom text-decoration-none text-capitalize"
													href="../blog/details-01.html"
													title="How to Plop Hair for Bouncy, Beautiful Curls"
													>Read more
													<svg
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-02-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-03-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-04-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-05-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-06-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
														alt="How To Choose The Right Sofa for your home"
														width="370"
														height="240"
									...
									<div class="row align-items-center">
										...
										>
											...
											>
												...
												>
													<img
														data-src="{{ asset('/images/blog/post-07-370x240.jpg') }}"
														class="img-fluid lazy-image w-100"
										...
										<li class="col-12">
											<div class="card border-0 flex-row">
												...
												>
													...
													>
														<img
															data-src="{{ asset('/images/blog/post-12-60x80.jpg') }}"
										...
										<li class="col-12">
											<div class="card border-0 flex-row">
												...
												>
													...
													>
														<img
															data-src="{{ asset('/images/blog/post-14-60x80.jpg') }}"
															class="img-fluid lazy-image"
															alt="How to Plop Hair for Bouncy, Beautiful Curls"
															width="60"
															height="80"
										...
										<li class="col-12">
											<div class="card border-0 flex-row">
												...
												>
													...
													>
														<img
															data-src="{{ asset('/images/blog/post-11-60x80.jpg') }}"
															class="img-fluid lazy-image"
															alt="Which foundation formula is right for your skin?"
															width="60"
															height="80"
										...
										<li class="col-12">
											<div class="card border-0 flex-row">
												...
												>
													...
													>
														<img
															data-src="{{ asset('/images/blog/post-15-60x80.jpg') }}"
															class="img-fluid lazy-image"
															alt="A User-Friendly Guide to Natural Cleansers"
															width="60"
															height="80"
								...
								<div class="widget widget-banner">
									<div class="card border-0">
										<img
											...
											data-src="{{ asset('/images/blog/widget-banner-img.jpg') }}"
									...
									<div class="row g-10px">
										<div class="col-4">
											<a
												...
												href="{{ asset('/images/instagram/instagram-01.jpg') }}"
												title="instagram-01"
											...
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-01-106x106.jpg') }}"
													alt="instagram-01"
													src="#"
												/>
												<span
										...
										<div class="col-4">
											<a
												class="card-img-overlay-hover hover-zoom-in d-block"
												href="{{ asset('/images/instagram/instagram-02.jpg') }}"
												title="instagram-02"
												data-gallery="widget_instagram"
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-02-106x106.jpg') }}"
													alt="instagram-02"
													src="#"
												/>
												<span
										...
										<div class="col-4">
											<a
												class="card-img-overlay-hover hover-zoom-in d-block"
												href="{{ asset('/images/instagram/instagram-03.jpg') }}"
												title="instagram-03"
												data-gallery="widget_instagram"
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-03-106x106.jpg') }}"
													alt="instagram-03"
													src="#"
												/>
												<span
										...
										<div class="col-4">
											<a
												class="card-img-overlay-hover hover-zoom-in d-block"
												href="{{ asset('/images/instagram/instagram-04.jpg') }}"
												title="instagram-04"
												data-gallery="widget_instagram"
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-04-106x106.jpg') }}"
													alt="instagram-04"
													src="#"
												/>
												<span
										...
										<div class="col-4">
											<a
												class="card-img-overlay-hover hover-zoom-in d-block"
												href="{{ asset('/images/instagram/instagram-05.jpg') }}"
												title="instagram-05"
												data-gallery="widget_instagram"
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-05-106x106.jpg') }}"
													alt="instagram-05"
													src="#"
												/>
												<span
										...
										<div class="col-4">
											<a
												class="card-img-overlay-hover hover-zoom-in d-block"
												href="{{ asset('/images/instagram/instagram-06.jpg') }}"
												title="instagram-06"
												data-gallery="widget_instagram"
											>
												<img
													...
													width="106"
													height="106"
													data-src="{{ asset('/images/instagram/instagram-06-106x106.jpg') }}"
													alt="instagram-06"
													src="#"
												/>
												<span
			...
			<div class="container container-xxl pt-4">
				...
				<div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
					...
					>
						<a class="d-inline-block" href="../">
							<img
								...
								src="#"
								data-src="{{ asset('/images/others/logo.png') }}"
								width="179"
								height="26"
								alt="Glowing - Bootstrap 5 HTML Templates"
							/>
							<img
								...
								src="#"
								data-src="{{ asset('/images/others/logo-white.png') }}"
								width="179"
								height="26"
								alt="Glowing - Bootstrap 5 HTML Templates"
							/>
					...
					>
						<img
							src="#"
							data-src="{{ asset('/images/footer/img_1.png') }}"
							width="313"
							height="28"
							alt="Paypal"
							class="img-fluid lazy-image"
		...
		<script src="{{ asset('/vendors/lightgallery/plugins/zoom/lg-zoom.min.js') }}"></script>
		<script src="{{ asset('/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js') }}"></script>
		<script src="{{ asset('/vendors/lightgallery/plugins/video/lg-video.min.js') }}"></script>
		<script src="{{ asset('/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js') }}"></script>
		<script src="{{ asset('/vendors/isotope/isotope.pkgd.min.js') }}"></script>
		<script src="{{ asset('/vendors/slick/slick.min.js') }}"></script>
		<script src="{{ asset('/vendors/gsap/gsap.min.js') }}"></script>
		<script src="{{ asset('/vendors/gsap/ScrollToPlugin.min.js') }}"></script>
		<script src="{{ asset('/vendors/gsap/ScrollTrigger.min.js') }}"></script>
							...
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img
												src="{{ asset('/images/products/product-03-75x100.jpg') }}"
												width="60"
												height="80"
							...
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img
												src="{{ asset('/images/products/product-06-75x100.jpg') }}"
												width="60"
												height="80"
												alt="natural coconut cleansing oil"
											/>
							...
							<tr class="position-relative">
								...
								<td class="shop-product">
									<div class="d-flex align-items-center">
										<div class="me-6">
											<img
												src="{{ asset('/images/products/product-09-75x100.jpg') }}"
												width="60"
												height="80"
												alt="natural coconut cleansing oil"
											/>
						...
						<div class="row">
							<div class="col-md-6 pe-13">
								<div class="position-relative">
									...
									>
										<a
											href="{{ asset('/images/shop/product-gallery-05.jpg') }}"
											data-gallery="gallery1"
											><img
												src="#"
												data-src="{{ asset('/images/shop/product-gallery-05.jpg') }}"
										...
										/></a>
										<a
											href="{{ asset('/images/shop/product-gallery-06.jpg') }}"
											data-gallery="gallery1"
											><img
												src="#"
												data-src="{{ asset('/images/shop/product-gallery-06.jpg') }}"
												class="h-auto lazy-image"
												width="540"
												height="720"
												alt=""
										/></a>
										<a
											href="{{ asset('/images/shop/product-gallery-07.jpg') }}"
											data-gallery="gallery1"
											><img
												src="#"
												data-src="{{ asset('/images/shop/product-gallery-07.jpg') }}"
												class="h-auto lazy-image"
												width="540"
												height="720"
												alt=""
										/></a>
										<a
											href="{{ asset('/images/shop/product-gallery-08.jpg') }}"
											data-gallery="gallery1"
											><img
												src="#"
												data-src="{{ asset('/images/shop/product-gallery-08.jpg') }}"
												class="h-auto lazy-image"
												width="540"
												height="720"
												alt=""
								...
								<div class="mt-6">
									...
									>
										<img
											src="#"
											data-src="{{ asset('/images/shop/product-gallery-05-154x205.jpg') }}"
										...
										<img
											src="#"
											data-src="{{ asset('/images/shop/product-gallery-08-154x205.jpg') }}"
											class="mx-3 px-0 h-auto cursor-pointer lazy-image"
											width="75"
											height="100"
											alt=""
							...
							<div class="col-md-6 pt-md-0 pt-10">
								...
								>
									<div class="pt-8 px-5">
										<img
											class="img-fluid"
											src="{{ asset('/images/shop/product-info-2.png') }}"
											alt="pay"
											width="357"
											height="28"
										/>
