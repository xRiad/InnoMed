...
@section('title')
Product Details 05 - Glowing - Bootstrap 5 HTML Templates
@endsection
...
<main id="content" class="wrapper layout-page">
        ...
        <div class="row">
            <div class="col-md-6 pe-lg-13">
                <div class="position-sticky top-0">
                    <div class="row">
                        <div
                            class="col-xl-2 pe-xl-0 order-1 order-xl-0 mt-5 mt-xl-0"
                        >
                            <div
                                id="slide-thumb-5"
                            ...
                            >
                                <img
                                    src="#"
                                    data-src="../assets/images/shop/product-gallery-01-154x205.jpg"
                                    class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7"
                                    width="540"
                                    height="720"
                                    alt=""
                                />
                                <img
                                    src="#"
                                    data-src="../assets/images/shop/product-gallery-02-154x205.jpg"
                                    class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7"
                                    width="540"
                                    height="720"
                                    alt=""
                                ...
                                <img
                                    src="#"
                                    data-src="../assets/images/shop/product-gallery-03-154x205.jpg"
                                    class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7"
                                    width="540"
                                    height="720"
                                    alt=""
                                ...
                                <img
                                    src="#"
                                    data-src="../assets/images/shop/product-gallery-04-154x205.jpg"
                                    class="cursor-pointer lazy-image h-auto mx-3 mx-xl-0 px-0 mb-xl-7"
                                    width="540"
                                    height="720"
                                    alt=""
                        ...
                        <div
                            class="col-xl-10 ps-xl-8 pe-xl-0 order-0 order-xl-1"
                        >
                            ...
                            >
                                <a
                                    href="../assets/images/shop/product-gallery-01.jpg"
                                    data-gallery="gallery5"
                                    ><img
                                        src="#"
                                        data-src="../assets/images/shop/product-gallery-01.jpg"
                                ...
                                /></a>
                                <a
                                    href="../assets/images/shop/product-gallery-02.jpg"
                                    data-gallery="gallery5"
                                    ><img
                                        src="#"
                                        data-src="../assets/images/shop/product-gallery-02.jpg"
                                        class="h-auto lazy-image"
                                        width="540"
                                        height="720"
                                        alt=""
                                /></a>
                                <a
                                    href="../assets/images/shop/product-gallery-03.jpg"
                                    data-gallery="gallery5"
                                    ><img
                                        src="#"
                                        data-src="../assets/images/shop/product-gallery-03.jpg"
                                        class="h-auto lazy-image"
                                        width="540"
                                        height="720"
                                        alt=""
                                /></a>
                                <a
                                    href="../assets/images/shop/product-gallery-04.jpg"
                                    data-gallery="gallery5"
                                    ><img
                                        src="#"
                                        data-src="../assets/images/shop/product-gallery-04.jpg"
                                        class="h-auto lazy-image"
                                        width="540"
                                        height="720"
                                        alt=""
            ...
            <div class="col-md-6 pt-md-0 pt-10">
                ...
                <p class="fs-15px">
                    ...
                    superstars but not usually formulated together
                    because of their different pH levels.
                </p>

                <form class="pb-8">
                    <div
                        class="form-group shop-swatch mb-7 d-flex align-items-center"
                    >
                        <span
                            class="fw-semibold text-body-emphasis me-7"
                            >Size:
                        </span>
                        <ul
                        ...
                        >
                            <li
                                class="list-inline-item me-4 fw-semibold"
                            >
                                <input
                                    type="radio"
                                    id="radio1"
                    ...
                    <div class="form-group product-color mb-7 mt-3">
                        <label class="mb-2 pb-4"
                            ><span
                                class="fw-semibold text-body-emphasis me-2 pe-4"
                                >Color:</span
                            >
                            <span>Green - Revitalizing</span></label
                        >
                        <ul
                            class="list-inline d-flex justify-content-start mb-0"
                        >
                            <li
                                class="list-inline-item list-color-product selected p-3"
                            >
                                <a
                                    href="#"
                                    class="d-block color-item green-revitalizing"
                                ></a>
                            </li>
                            <li
                                class="list-inline-item list-color-product p-3"
                            >
                                <a
                                    href="#"
                                    class="d-block color-item pink"
                                ></a>
                            </li>
                            <li
                                class="list-inline-item list-color-product p-3"
                            >
                                <a
                                    href="#"
                                    class="d-block color-item green"
                                ></a>
                            </li>
                            <li
                                class="list-inline-item list-color-product p-3"
                            >
                                <a
                                    href="#"
                                    class="d-block color-item purple"
                                ></a>
                            </li>
                        </ul>
                        <select
                ...
                <div class="mt-13">
                    ...
                    >
                        ...
                        >
                            <div class="pt-8 pb-3">
                                <p
                                    class="fw-semibold text-body-emphasis mb-2 pb-4"
                                >
                                ...
                                <p class="mb-2 pb-4">
                                    ...
                                    vitamins, and other skin-nourishing
                                    nutrients. Creamy liquid formula
                                    sets with a pristine matte finish
                                    for soft, velvety smooth skin.
                                </p>
                                <p class="mb-7">
                                    Say hello to flawless, long-lasting
                                    foundation that comes in 7
                                    melt-into-your-skin shades. This
                                    lightweight, innovative formula
                                    creates a smooth, natural matte
                                    finish that won’t settle into lines.
                                    It’s the perfect fit for your skin.
                                    1 fl. oz.
                                </p>
                                <p
                                    class="fw-semibold text-body-emphasis mb-2 pb-4"
                                ...
                                <ul class="mb-5 ps-6">
                                    ...
                                    <li>
                                        Available in 07 shades (all
                                        exclusive to Makeaholic!)
                                    </li>
                                </ul>
                                <div class="row">
                                    <div
                                        class="col-6 col-md-3 text-center mb-9 pb-2"
                                    >
                                        <img
                                            class="lazy-image light-mode-img"
                                            src="#"
                                        ...
                                        />
                                        <img
                                            class="lazy-image dark-mode-img"
                                            src="#"
                        ...
                        >
                            <div class="pt-8 pb-3">
                                <p
                                    class="fw-semibold text-body-emphasis mb-2 pb-4"
                                >
                                    Follow these safety guidelines when
                                    using cosmetics products of any
                                    type:
                                </p>
                                <ul class="ps-6 mb-8">
                                    <li class="mb-3">
                                        Read the label. Follow all
                                        directions and heed all
                                        warnings.
                                    </li>
                                    <li class="mb-3">
                                        Wash your hands before you use
                                        the product.
                                    </li>
                                    <li class="mb-3">
                                        Do not share makeup.
                                    ...
                                    <li class="mb-3">
                                        Throw away cosmetics if there
                                        are changes in color or smell.
                                    </li>
                                    <li>
                                        Use aerosols or sprays cans in
                                        well-ventilated areas. Do not
                                        use them while you are smoking
                                        or near an open flame. It could
                                        start a fire.
                                    </li>
                                </ul>
                            </div>
                        ...
                        >
                            <div class="pt-8 pb-3">
                                <div class="table-responsive mb-5">
                                    ...
                                    >
                                        <tbody>
                                            <tr>
                                                <td
                                                    class="ps-0 py-5 pe-5 text-body-emphasis"
                                                >
                                                    CAS
                                                </td>
                                                <td
                                                    class="text-end py-5 ps-5 pe-0"
                                                >
                                                    92128-82-0,
                                                    9057-02-7
                                                </td>
                                ...
                                <p>
                                    Perfect for Equestrian homes or
                                    every horse lover. Designer premium
                                    signature aluminum alloy all Arthur
                                    Court is compliance with FDA
                                    regulations. Aluminum Serveware can
                                    be chilled in the freezer or
                                    refrigerator and warmed in the oven
                                    to 350. Wash by hand with mild dish
                                    soap and dry immediately – do not
                                    put in the dishwasher. Comes in Gift
                                    Box perfect for Equestrian home or
    ...
    <section
        class="container container-xxl pt-15 pb-15 pt-lg-17 pb-lg-20"
    >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                src="#"
                                data-src="../assets/images/products/product-04-330x440.jpg"
                                class="img-fluid lazy-image w-100"
                                alt="Shield Shampoo"
                                width="330"
                                height="440"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                src="#"
                                data-src="../assets/images/products/product-07-330x440.jpg"
                                class="img-fluid lazy-image w-100"
                                alt="Shield Spray"
                                width="330"
                                height="440"
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                src="#"
                                data-src="../assets/images/products/product-08-330x440.jpg"
                                class="img-fluid lazy-image w-100"
                                alt="Shield Spray"
                                width="330"
                                height="440"
